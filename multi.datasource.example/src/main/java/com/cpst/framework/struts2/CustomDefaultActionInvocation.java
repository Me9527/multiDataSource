...
public class CustomDefaultActionInvocation implements ActionInvocation {
	private static final long serialVersionUID = -4643532462949517400L;
    ...
    private String resultPrefix = "/jsp/";
    
    public CustomDefaultActionInvocation(final Map<String, Object> extraContext, final boolean pushAction) {
    	CustomDefaultActionInvocation.this.extraContext = extraContext;
    	CustomDefaultActionInvocation.this.pushAction = pushAction;
    }
    ...
    //TODO comment
    private ResultConfig getCustomResult() {
    	if(null == resultCode || !(resultCode instanceof String))
    		return null;
    	String resultClass = "org.apache.struts2.dispatcher.ServletDispatcherResult";
    	Map<String,String> params = new HashMap<String,String>();
    	String rs = resultPrefix + proxy.getConfig().getPackageName() + "/" + resultCode + ".jsp";
    	params.put("location", rs);
        ResultConfig resultConfig = new ResultConfig.Builder(resultCode, resultClass)
    ...
    public String invoke() throws Exception {
        ...
        try {
            ...
            if (interceptors.hasNext()) {
                ...
                try {
                                resultCode = interceptor.getInterceptor().intercept(CustomDefaultActionInvocation.this);
                            }
                finally {
